...
export const metadata: Metadata = {
  ...
  description: 'Get your free, no-pressure in-home consultation with Apex Design. Licensed, insured remodeling contractor serving Orange County. Call (949) 878-3250.',
